...
| directors          | <string>                                                                                                                                                                                                            | TV show's directors (only valid for tvshows; or all for every values)           |
| genres             | <string>                                                                                                                                                                                                            | TV show's genres (only valid for tvshows; or all for every values)              |
| platforms          | <string>                                                                                                                                                                                                            | TV show's platforms (only valid for tvshows; or all for every values)           |
