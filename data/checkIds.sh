      ...
      if [[ $3 == "allocine" ]] || [[ $IMDB_ID_FROM_FILE == "null" ]] || [[ $BETASERIES_ID_FROM_FILE == "null" ]] || [[ $THEMOVIEDB_ID_FROM_FILE == "null" ]] || [[ $METACRITIC_ID_FROM_FILE == "null" ]] || [[ $ROTTEN_TOMATOES_ID_FROM_FILE == "null" ]] || [[ $LETTERBOXD_ID_FROM_FILE == "null" ]] || [[ $SENSCRITIQUE_ID_FROM_FILE == "null" ]]; then
        ...
        if [[ $WIKI_URL ]]; then
          ...
          if [[ $3 == "allocine" ]]; then
            ...
            if [[ $FOUND -eq 1 ]]; then
              echo "$BASE_URL_ALLOCINE$ALLOCINE_ID_TO_USE.html,$IMDB_ID_FROM_FILE,$BETASERIES_ID_FROM_FILE,$THEMOVIEDB_ID_FROM_FILE,$METACRITIC_ID_FROM_FILE,$ROTTEN_TOMATOES_ID_FROM_FILE,$LETTERBOXD_ID_FROM_FILE,$SENSCRITIQUE_ID_FROM_FILE" >> $FILMS_IDS_FILE_PATH_TEMP
            fi
          else
            if { [[ $METACRITIC_ID != $METACRITIC_ID_FROM_FILE ]] && [[ $METACRITIC_ID != "null" ]]; } ||
              ...
              echo "$URL,$IMDB_ID_FROM_FILE,$BETASERIES_ID_FROM_FILE,$THEMOVIEDB_ID_FROM_FILE,$METACRITIC_ID_TO_USE,$ROTTEN_TOMATOES_ID_TO_USE,$LETTERBOXD_ID_TO_USE,$SENSCRITIQUE_ID_TO_USE" >> $FILMS_IDS_FILE_PATH_TEMP       
            fi
          fi
        fi
      fi
